...
export class IndexComponent implements OnInit {
  categories: string[] = ['Grails Apprentice', 'GORM', 'Grails Testing', 'Advanced Grails', 'Grails + Google Cloud', 'Grails + Angular', 'Grails + AngularJS', 'Grails + React', 'Grails + RIA (Rich Internet Application)', 'Grails + iOS', 'Grails + Android'];
  guides: Guide[] = [];
